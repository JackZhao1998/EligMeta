def exclude_phase_iii_few_enrollment(row):
    ...
    # Condition 1: Determine if the trial is a Phase III trial. Return 'Yes' or 'No' only. Do not explain your answer. (equal_to Yes)
    fields_cond_0 = ["Phase"]
    ...
    parsed_cond_0 = llm_parser(input_text_cond_0, "Determine if the trial is a Phase III trial. Return 'Yes' or 'No' only. Do not explain your answer.").strip()
