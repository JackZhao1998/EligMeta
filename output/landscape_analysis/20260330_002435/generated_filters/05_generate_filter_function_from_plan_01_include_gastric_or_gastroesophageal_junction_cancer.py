def include_gastric_or_gastroesophageal_junction_cancer(row):
    ...
    # Condition 1: Check if the trial studies gastric cancer or gastroesophageal junction cancer. Return 'Yes' if either condition is mentioned, otherwise return 'No'. Do not explain your answer. (equal_to Yes)
    ...
    parsed_cond_0 = llm_parser(input_text_cond_0, "Check if the trial studies gastric cancer or gastroesophageal junction cancer. Return 'Yes' if either condition is mentioned, otherwise return 'No'. Do not explain your answer.").strip()
